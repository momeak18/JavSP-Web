...
const FORM_TABS = [
  ...
  { id: 'folder', section: 'summarizer', prefixes: ['move_files', 'copy_files', 'path', 'title'], label: '文件夹整理', description: '设置输出目录、文件名、路径长度和文件复制规则。' },
...
const FIELD_DESCRIPTIONS = {
  ...
  'summarizer.move_files': '启用文件整理功能。Web 刮削任务会复制源文件到输出目录。',
  'summarizer.copy_files': 'Web 刮削任务复制文件到整理目录并保留原始文件。',
